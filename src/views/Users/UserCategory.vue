      ...
      <b-col md="12">
        <b-card>
          ...
          <b-form-group
            ...
            :label-cols="3"
            :horizontal="true">
            <b-form-input id="basicName" v-model="input.name" type="text" autocomplete="name" placeholder="Enter the name of User Category" required ></b-form-input>
          </b-form-group>
